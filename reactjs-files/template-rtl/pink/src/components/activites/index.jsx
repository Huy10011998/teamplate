  ...
  render() {
    ...
    const columns = [
     
      {
        ...
        dataIndex: "subject",
        render: (text, record) => (
          <><a href="#" data-toggle="modal" data-target="#add_activity">{text}</a></>
          ),
      ...
      },
      {
        ...
        render: (text, record) => (
          ...
          <a className="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
          ...
          <div className="row">
            <div className="col">
              <div className="dropdown">
                <a className="dropdown-toggle recently-viewed" role="button" data-toggle="dropdown" aria-expanded="false"> Propose Times </a>
            ...
            <div className="col text-right">
              <ul className="list-inline-item pl-0">
                <li className="list-inline-item">
                  <button className="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" id="add-task" data-toggle="modal" data-target="#add_activity">Add Activity</button>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="modal right fade" id="company-details" tabIndex={-1} role="dialog" aria-modal="true">
            ...
            <div className="modal-body">
              <div className="task-infos">
                <ul className="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
                  ...
                  <li className="nav-item"><a className="nav-link" href="#task-news" data-toggle="tab">News</a></li>
                </ul>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td>
                                        ...
                                        <a data-toggle="modal" data-target="#company-details">Clampett Oil and Gas Corp.</a>
                                      </td>
                                      <td>8754554531</td>
                                      <td>United States</td>
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <a data-toggle="modal" data-target="#company-details">Acme Corporation</a>
                                      </td>
                                      <td>8754554531</td>
                                      <td>United States</td>
                                      <td className="text-center">
       ...
       <div className="modal right fade" id="add_activity" tabIndex={-1} role="dialog" aria-modal="true">
        <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
          <button type="button" className="close md-close" data-dismiss="modal" aria-label="Close">
              ...
              <div className="modal-body">
                ...
                <div className="row">
                  <div className="pipeline-small flat pl-3 pr-3 w-100">
                    <a className="won noselect tipped-top text-white" data-toggle="tooltip" data-placement="top" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i className="fa fa-check" aria-hidden="true" /><br /><span>Prospecting</span></a>
                    <a className="won noselect tipped-top bg-gray text-white" data-toggle="tooltip" data-placement="top" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i className="fa fa-check" aria-hidden="true" /><br /><span>Qualification</span></a>
                    <a className="won noselect tipped-top text-white" data-toggle="tooltip" data-placement="top" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i className="fa fa-check" aria-hidden="true" /><br /><span>Needs Analysis</span></a>
                    <a className="won noselect tipped-top text-white" data-toggle="tooltip" data-placement="top" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i className="fa fa-check" aria-hidden="true" /><br /><span>Proposals</span></a>
                    <a className="won noselect tipped-top text-white" data-toggle="tooltip" data-placement="top" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i className="fa fa-check" aria-hidden="true" /><br /><span>Nogatiation</span></a>
                    <a className="won noselect tipped-top text-white padding" data-toggle="tooltip" data-placement="top" data-original-title="Pipeline: Deal Pipeline">&nbsp;closed win</a>
                  </div>
                </div>
                <div className="task-infos pt-3">
                  <ul className="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
                    <li className="nav-item"><a className="nav-link active" href="#pipeline-task-details" data-toggle="tab">Details</a></li>
                    <li className="nav-item"><a className="nav-link" href="#pipeline-task-related" data-toggle="tab">Related</a></li>
                  </ul>
                  <div className="tab-content">
                    ...
                    <div className="tab-pane task-related" id="pipeline-task-related">
                      ...
                      <div className="row">
                        <div className="crms-tasks  p-2">
                          <div className="tasks__item crms-task-item active">
                            <div className="accordion-header js-accordion-header">Companies <span className="badge badge-secondary float-right">2</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                                <div className="table-responsive">
                                  <table className="table table-striped table-nowrap custom-table mb-0">
                          ...
                          <div className="tasks__item crms-task-item">
                            <div className="accordion-header js-accordion-header">Deals <span className="badge badge-secondary float-right">2</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                                <div className="table-responsive">
                                  <table className="table table-striped table-nowrap custom-table mb-0">
                          ...
                          <div className="tasks__item crms-task-item">
                            <div className="accordion-header js-accordion-header">Projects <span className="badge badge-secondary float-right">1</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                                <div className="table-responsive">
                                  <table className="table table-striped table-nowrap custom-table mb-0 ">
                          ...
                          <div className="tasks__item crms-task-item">
                            <div className="accordion-header js-accordion-header">Contacts <span className="badge badge-secondary float-right">2</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                                <div className="table-responsive">
                                  <table className="table table-striped table-nowrap custom-table mb-0">
                          ...
                          <div className="tasks__item crms-task-item">
                            <div className="accordion-header js-accordion-header">Notes <span className="badge badge-secondary float-right">2</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                                <div className="table-responsive">
                                  <table className="table table-striped table-nowrap custom-table mb-0">
                          ...
                          <div className="tasks__item crms-task-item">
                            <div className="accordion-header js-accordion-header">Files <span className="badge badge-secondary float-right">2</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                                <div className="table-responsive">
                                  <table className="table table-striped table-nowrap custom-table mb-0">
                  ...
                  <div className="tab-content">
                    ...
                    <div className="tab-pane task-related" id="task-related">
                      ...
                      <div className="row">
                        <div className="crms-tasks  p-2">
                          <div className="tasks__item crms-task-item active">
                            <div className="accordion-header js-accordion-header">Companies <span className="badge badge-secondary float-right">0</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                              </div>
                            </div>
                          ...
                          <div className="tasks__item crms-task-item">
                            <div className="accordion-header js-accordion-header">Deals <span className="badge badge-secondary float-right">0</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                              </div>
                            </div>
                          ...
                          <div className="tasks__item crms-task-item">
                            <div className="accordion-header js-accordion-header">Projects <span className="badge badge-secondary float-right">0</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                              </div>
                            </div>
                          ...
                          <div className="tasks__item crms-task-item">
                            <div className="accordion-header js-accordion-header">Contacts <span className="badge badge-secondary float-right">0</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                              </div>
                            </div>
                          ...
                          <div className="tasks__item crms-task-item">
                            <div className="accordion-header js-accordion-header">Notes <span className="badge badge-secondary float-right">0</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                              </div>
                            </div>
                          ...
                          <div className="tasks__item crms-task-item">
                            <div className="accordion-header js-accordion-header">Files <span className="badge badge-secondary float-right">0</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                              </div>
                            </div>
                    ...
                    <div className="tab-pane" id="task-activity">
                      ...
                      <div className="row">
                        <div className="crms-tasks  p-2">
                          <div className="tasks__item crms-task-item active">
                            <div className="accordion-header js-accordion-header">Upcoming Activity <span className="badge badge-secondary float-right">0</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                              </div>
                            </div>
                          ...
                          <div className="tasks__item crms-task-item">
                            <div className="accordion-header js-accordion-header">Past Activity <span className="badge badge-secondary float-right">0</span></div> 
                            <div className="accordion-body js-accordion-body">
                              <div className="accordion-body__contents">
                              </div>
                            </div>
              ...
              <div className="modal-body project-pipeline">
                ...
                <div className="row">
                  <div className="pipeline-small flat pipeline-project p-2 w-100">
                    <a className="won noselect tipped-top text-white w-25" data-toggle="tooltip" data-placement="top" data-original-title="Plan">&nbsp;<i className="fa fa-check" aria-hidden="true" /><br /><span>Plan</span>
                      <span className="stretched-link" data-toggle="modal" data-target="#pipeline-stage" data-dismiss="modal" />
                    </a>
                    <a className="won noselect tipped-top bg-gray text-white w-12" data-toggle="tooltip" data-placement="top" data-original-title="Design">&nbsp;<i className="fa fa-check" aria-hidden="true" /><br /><span>Design</span>
                      <span className="stretched-link" data-toggle="modal" data-target="#pipeline-stage" data-dismiss="modal" />
                    </a>
                    <a className="won noselect tipped-top text-white w-25" data-toggle="tooltip" data-placement="top" data-original-title="Develop">&nbsp;<i className="fa fa-check" aria-hidden="true" /><br /><span>Develop</span>
                      <span className="stretched-link" data-toggle="modal" data-target="#pipeline-stage" data-dismiss="modal" />
                    </a>
                    <a className="won noselect tipped-top text-white padding w-25" data-toggle="tooltip" data-placement="top" data-original-title="COmplete">&nbsp;Complete
                    </a>
                  </div>
                </div>
                <div className="task-infos pt-3">
