                 ...
                 <div className="email-content pt-3">
                   <div className="table-responsive">
                     <table className="table table-inbox table-hover">
                       ...
                       <tbody>
                         <tr className="unread clickable-row" data-href="/template-rtl/gradient-pink/mail-view">
                           <td>
                         ...
                         <tr className="clickable-row" data-href="/template-rtl/gradient-pink/mail-view">
                           <td>
                             <label className="container-checkbox">
                               <input type="checkbox" />
                               <span className="checkmark" />
