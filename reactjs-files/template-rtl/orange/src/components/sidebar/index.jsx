    ...
    <div className="sidebar-inner slimscroll">
      ...
      <div id="sidebar-menu" className="sidebar-menu">
        <ul>
          ...
          <li> 
            <a className={`${pathname.includes("email") ? "active" : ""}`} href="/template-rtl/orange/email"><i className="feather-mail" /> <span>Email</span></a>
          </li>
          <li className="menu-title"> 
            <span>Pages</span>
          </li>
          ...
          <li> 
            <a className={`${pathname.includes("components") ? "active" : ""}`} href="/template-rtl/orange/components"><i className="feather-layout" /> <span>Components</span></a>
          </li>
          <li className="submenu">
