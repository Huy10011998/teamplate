            ...
            <div className="row">
              <div className="col">
                <div className="dropdown">
                  <a className="dropdown-toggle recently-viewed" href="#" role="button" data-toggle="dropdown" aria-expanded="false"> All Projects</a>
              ...
              <div className="col text-right">
                <ul className="list-inline-item pl-0">
                  <li className="dropdown list-inline-item add-lists">
                    <a className="dropdown-toggle recently-viewed pr-2" href="#" role="button" data-toggle="dropdown" aria-expanded="false"> 
                  ...
                  <li className="list-inline-item">
                    <button className="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" id="add-task" data-toggle="modal" data-target="#add_project">New Project</button>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div>
                <div className="card-body p-0 row">
                  <div id="sortableKanbanBoards" className="col-md-12 kanban-views p-0">
                        ...
                        <div id="TODO" className="kanban-centered">
                          <article className="kanban-entry grab" id="item1" draggable="true">
                            <div className="kanban-entry-inner">
                              <div className="kanban-label card bg-gradient-danger card-img-holder text-white h-100" data-toggle="modal" data-target="#leads-details">
                          ...
                          <article className="kanban-entry grab" id="item2" draggable="true">
                            <div className="kanban-entry-inner">
                              <div className="kanban-label card bg-gradient-info card-img-holder text-white h-100" data-toggle="modal" data-target="#leads-details">
                                <img src={CircleImg} className="card-img-absolute" alt="circle-image" />
                          ...
                          <article className="kanban-entry grab" id="item4" draggable="true">
                            <div className="kanban-entry-inner">
                              <div className="kanban-label card bg-gradient-success card-img-holder text-white h-100" data-toggle="modal" data-target="#leads-details">
                                <img src={CircleImg} className="card-img-absolute" alt="circle-image" />
                    ...
                    <div className="panel panel-primary kanban-col mr-0">
                      <div className="panel-heading bg-transparent p-0">
                      ...
                      <div className="panel-body slimScrollDiv">
                        <div id="DOING" className="kanban-centered">
                          <article className="kanban-entry grab" id="item5" draggable="true">
                            <div className="kanban-entry-inner">
                              <div className="kanban-label card bg-gradient-warning card-img-holder text-white h-100" data-toggle="modal" data-target="#leads-details">
                                <img src={CircleImg} className="card-img-absolute" alt="circle-image" />
                                <h2 data-toggle="modal" data-target="#leads">Douglas Baker</h2>
                                <ul className="list-unstyled">
                                  <li>Finance Director</li>
            ...
            <div className="modal-body">
              <form className="forms-sample">
                ...
                <div className="text-center">
                  <button type="submit" className="btn btn-gradient-primary mr-2 btn-rounded">Submit</button>
