        ...
        render: (text, record) => (
         <>
	        <div className="pipeline-small flat pipeline-project">
              <a className="won noselect tipped-top planing" data-toggle="tooltip" data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline, stage: plan">&nbsp;
                <span className="stretched-link" data-toggle="modal" data-target="#project-details"></span>
              </a>
              <a className="won noselect tipped-top planing" data-toggle="tooltip" data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline, stage: plan">
                <span className="stretched-link" data-toggle="modal" data-target="#project-details"></span>
              </a>
              <a className="won noselect tipped-top" data-toggle="tooltip" data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline">
                <span className="stretched-link" data-toggle="modal" data-target="#project-details"></span>
              </a>
              <a className="won noselect tipped-top" data-toggle="tooltip" data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline">
                <span className="stretched-link" data-toggle="modal" data-target="#project-details"></span>
