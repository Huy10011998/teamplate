...
class Leadskanbanview extends Component {
            ...
            <div className="row">
              <div className="col">
                <div className="dropdown">
                  <a className="dropdown-toggle recently-viewed" href="#" role="button" data-toggle="dropdown" aria-expanded="false"> All Leads</a>
              ...
              <div className="col text-right">
                <ul className="list-inline-item pl-0">
                  ...
                  <li className="list-inline-item">
                    <button className="add btn btn-gradient-primary font-weight-bold text-white todo-list-add-btn btn-rounded" id="add-task" data-toggle="modal" data-target="#add_lead">New Lead</button>
                  </li>
                </ul>
              </div>
            </div>
