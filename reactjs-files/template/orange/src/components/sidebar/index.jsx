    ...
    <div className="sidebar-inner slimscroll">
      ...
      <div id="sidebar-menu" className="sidebar-menu">
        <ul>
          ...
          <li> 
            <a className={`${pathname.includes("email") ? "active" : ""}`} href="/orange/email"><i className="feather-mail" /> <span>Email</span></a>
          </li>
          <li className="menu-title"> 
            <span>Pages</span>
          </li>
          ...
          <li> 
            <a className={`${pathname.includes("components") ? "active" : ""}`} href="/orange/components"><i className="feather-layout" /> <span>Components</span></a>
          </li>
          <li className="submenu">
