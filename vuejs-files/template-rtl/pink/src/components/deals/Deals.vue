											...
											<tbody>
												<tr v-for="item in list" :key="item.id">
													...
													<td>
														...
														<a href="#" data-toggle="modal" data-target="#deal-details">{{item.dealname}}</a>
													</td>
													<td><a href="#" data-toggle="modal" data-target="#company-details">{{item.company}}</a></td>
													<td>
													...
													<td>{{item.forecastclosedate}}</td>
													<td>{{item.userresponsible}}</td>
                      ...
                      <div class="row w-100">
                        <div class="col-md-7 account d-flex">
                            ...
                            <div>
                              ...
                              <span class="rating-star ml-1"><i class="fa fa-star" aria-hidden="true"></i></span>
                              <span class="lock ml-1"><i class="fa fa-lock" aria-hidden="true"></i></span>
                            </div>
...
<script>
     import list from '../../json/deals/list'
	export default {
        data() {
            return {
                list: list,
