    ...
    <div>
                            ...
                            <div class="col">
                                <div class="dropdown">
                                    <a class="dropdown-toggle recently-viewed" href="#" role="button"
                                        data-toggle="dropdown" aria-expanded="false"> Propose Times </a>
                                ...
                                <ul class="list-inline-item pl-0">
                                    ...
                                    <li class="list-inline-item">
                                        <button
                                            ...
                                            id="add-task" data-toggle="modal" data-target="#add_activity">Add
                                            Activity</button>
                                    </li>
                                </ul>
                            </div>
                                            ...
                                            <tbody>
                                                <tr v-for="item in list" :key="item.id">
                                                    ...
                                                    <td><a href="#" data-toggle="modal"
                                                            data-target="#add_activity">{{item.subject}}</a></td>
                                                    <td><a href="#" data-toggle="modal"
                                                            data-target="#company-details">{{item.Deal}}</a></td>
                                                    <td>{{item.contactperson}}</td>
                                                    <td>{{item.email}}</td>
                                                    <td>{{item.phone}}</td>
                                                    <td><a href="#" data-toggle="modal"
                                                            data-target="#company-details">{{item.companies}}</a></td>
        ...
        <div class="modal right fade" id="company-details" tabindex="-1" role="dialog" aria-modal="true">
            <div class="modal-dialog" role="document">
                <button type="button" class="close md-close" data-dismiss="modal" aria-label="Close"><span
                        ...
                        <div class="row w-100">
                            <div class="col-md-7 account d-flex">
                                <div class="company_img">
                                    <img src="../../assets/img/c-logo.png" alt="User" class="img-fluid" />
                                </div>
                                <div>
                    ...
                    <div class="modal-body">
                        <div class="task-infos">
                            <ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#task-related"
                                        data-toggle="tab">Related</a></li>
                                <li class="nav-item"><a class="nav-link" href="#task-activity"
                                        data-toggle="tab">Activity</a></li>

                                <li class="nav-item"><a class="nav-link" href="#task-news" data-toggle="tab">News</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane show active" id="task-details">
                                    <div class="crms-tasks">
                                        ...
                                        <div class="tasks__item crms-task-item">
                                            <div class="accordion-header js-accordion-header">Organization Contact
                                                Details</div>
                                            <div class="accordion-body js-accordion-body">
                                                <div class="accordion-body__contents">
                                                    <table class="table">
                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="border-0">1000 Escalon Street, Palo Alto, CA,
                                                                    94020, United States map</td>
                                                            </tr>
                                                            <tr>
                                        ...
                                        <div class="tasks__item crms-task-item">
                                            <div class="accordion-header js-accordion-header">Additional Information
                                            </div>
                                            <div class="accordion-body js-accordion-body">
                                                <div class="accordion-body__contents">
                                                    <table class="table">
                                        ...
                                        <div class="tasks__item crms-task-item">
                                            <div class="accordion-header js-accordion-header">Description Information
                                            </div>
                                            <div class="accordion-body js-accordion-body">
                                                <div class="accordion-body__contents">
                                                    <table class="table">
                                                            ...
                                                            <table
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <a href="#" class="avatar"><img alt=""
                                                                                    src="../../assets/img/c-logo2.png"></a>
                                                                            <a href="#" data-toggle="modal"
                                                                                data-target="#company-details">Clampett
                                                                                Oil and Gas Corp.</a>
                                                                        </td>
                                                                        <td>8754554531</td>
                                                                        <td>United States</td>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <a href="#" class="avatar"><img alt=""
                                                                                    src="../../assets/img/c-logo.png"></a>
                                                                            <a href="#" data-toggle="modal"
                                                                                data-target="#company-details">Acme
                                                                                Corporation</a>
                                                                        </td>
                                                                        <td>8754554531</td>
                                                                        <td>United States</td>
                                ...
                                <div class="tab-pane" id="task-activity">
                                    ...
                                    <div class="row">
                                        <div class="crms-tasks  p-2">
                                            <div class="tasks__item crms-task-item active">
                                                <div class="accordion-header js-accordion-header">Upcoming Activity
                                                </div>
                                                <div class="accordion-body js-accordion-body">
                                                    <div class="accordion-body__contents">
                                                        <div class="table-responsive">
                                ...
                                <div class="tab-pane" id="task-news">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h4>News Items</h4>
                                            <p>Current news items about this Organization are sourced from Google News
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="deal-name" id="deal-name"
                                            value="Call">
                                    </div>
                                    <div class="btn-group mb-3">
                                        <button type="button" class="btn btn-light"><i class="fa fa-phone"
                                                aria-hidden="true"></i></button>
                                        <button type="button" class="btn btn-light"><i class="fa fa-users"
                                                aria-hidden="true"></i></button>
                                        <button type="button" class="btn btn-light"><i class="fa fa-clock-o"
                                                aria-hidden="true"></i></button>
                                        <button type="button" class="btn btn-light"><i class="fa fa-flag"
                                                aria-hidden="true"></i></button>
                                        <button type="button" class="btn btn-light"><i class="fa fa-paper-plane-o"
                                                aria-hidden="true"></i></button>
                                        <button type="button" class="btn btn-light"><i class="fa fa-cutlery"
                                                aria-hidden="true"></i></button>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="cal-icon"><input class="form-control datetimepicker"
                                                        type="text" placeholder="MM/DD/YY"></div>
                                            </div>
                                            <div class="col-md-3">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="row m-0">
                                            <p>Add <a href="">Guests</a>, <a href="">Location</a>, <a
                                                    href="">Description</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <span class="pt-2">Notes are private and visible only within your Pipedrive
                                            account</span>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="pipeline-small flat pl-3 pr-3 w-100">
                                <a class="won noselect tipped-top text-white" data-toggle="tooltip" data-placement="top"
                                    title="" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i class="fa fa-check"
                                        aria-hidden="true"></i><br><span>Prospecting</span></a>
                                <a class="won noselect tipped-top bg-gray text-white" data-toggle="tooltip"
                                    data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i
                                        class="fa fa-check" aria-hidden="true"></i><br><span>Qualification</span></a>
                                <a class="won noselect tipped-top text-white" data-toggle="tooltip" data-placement="top"
                                    title="" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i class="fa fa-check"
                                        aria-hidden="true"></i><br><span>Needs Analysis</span></a>
                                <a class="won noselect tipped-top text-white" data-toggle="tooltip" data-placement="top"
                                    title="" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i class="fa fa-check"
                                        aria-hidden="true"></i><br><span>Proposals</span></a>
                                <a class="won noselect tipped-top text-white" data-toggle="tooltip" data-placement="top"
                                    title="" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i class="fa fa-check"
                                        aria-hidden="true"></i><br><span>Nogatiation</span></a>
                                <a class="won noselect tipped-top text-white padding" data-toggle="tooltip"
                                    data-placement="top" title=""
                                    data-original-title="Pipeline: Deal Pipeline">&nbsp;closed win</a>
                            </div>
                        </div>
                        <div class="task-infos pt-3">
                            <ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
                                <li class="nav-item"><a class="nav-link active" href="#pipeline-task-details"
                                        data-toggle="tab">Details</a></li>
                                <li class="nav-item"><a class="nav-link" href="#pipeline-task-related"
                                        data-toggle="tab">Related</a></li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="pipeline-task-details">
                                    <div class="crms-tasks">
                                        ...
                                        <div class="tasks__item crms-task-item">
                                            ...
                                            <div class="accordion-body js-accordion-body">
                                                <div class="accordion-body__contents">
                                                    <button class="btn btn-secondary text-white w-25">Add
                                                        Comments</button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane task-related" id="pipeline-task-related">
                                    ...
                                    <div class="row">
                                        <div class="crms-tasks  p-2">
                                            <div class="tasks__item crms-task-item active">
                                                <div class="accordion-header js-accordion-header">Companies <span
                                                        class="badge badge-secondary float-right">2</span></div>
                                                <div class="accordion-body js-accordion-body">
                                                    <div class="accordion-body__contents">
                                                        <div class="table-responsive">
                                                            <table
                                            ...
                                            <div class="tasks__item crms-task-item">
                                                <div class="accordion-header js-accordion-header">Deals <span
                                                        class="badge badge-secondary float-right">2</span></div>
                                                <div class="accordion-body js-accordion-body">
                                                    <div class="accordion-body__contents">
                                                        <div class="table-responsive">
                                            ...
                                            <div class="tasks__item crms-task-item">
                                                <div class="accordion-header js-accordion-header">Projects <span
                                                        class="badge badge-secondary float-right">1</span></div>
                                                <div class="accordion-body js-accordion-body">
                                                    <div class="accordion-body__contents">
                                                        <div class="table-responsive">
                                                            <table
                                            ...
                                            <div class="tasks__item crms-task-item">
                                                <div class="accordion-header js-accordion-header">Contacts <span
                                                        class="badge badge-secondary float-right">2</span></div>
                                                <div class="accordion-body js-accordion-body">
                                                    <div class="accordion-body__contents">
                                                        <div class="table-responsive">
                                            ...
                                            <div class="tasks__item crms-task-item">
                                                <div class="accordion-header js-accordion-header">Notes <span
                                                        class="badge badge-secondary float-right">2</span></div>
                                                <div class="accordion-body js-accordion-body">
                                                    <div class="accordion-body__contents">
                                                        <div class="table-responsive">
                                            ...
                                            <div class="tasks__item crms-task-item">
                                                <div class="accordion-header js-accordion-header">Files <span
                                                        class="badge badge-secondary float-right">2</span></div>
                                                <div class="accordion-body js-accordion-body">
                                                    <div class="accordion-body__contents">
                                                        <div class="table-responsive">
                                                                ...
                                                                <td>
                                                                    <div class="form-check m-0 pl-0">
                                                                        <label class="form-check-label">
                                                                            <input class="checkbox" type="checkbox"> <i
                                ...
                                <div class="tab-pane task-related" id="task-related">
                                    ...
                                    <div class="row">
                                        <div class="crms-tasks  p-2">
                                            <div class="tasks__item crms-task-item active">
                                                <div class="accordion-header js-accordion-header">Companies <span
                                                        class="badge badge-secondary float-right">0</span></div>
                                                <div class="accordion-body js-accordion-body">
                                                    <div class="accordion-body__contents">
                                                    </div>
                                                </div>
                                ...
                                <div class="tab-pane" id="task-activity">
                                    ...
                                    <div class="row">
                                        <div class="crms-tasks  p-2">
                                            <div class="tasks__item crms-task-item active">
                                                <div class="accordion-header js-accordion-header">Upcoming Activity
                                                    <span class="badge badge-secondary float-right">0</span></div>
                                                <div class="accordion-body js-accordion-body">
                                                    <div class="accordion-body__contents">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="tasks__item crms-task-item">
                                                <div class="accordion-header js-accordion-header">Past Activity <span
                                                        class="badge badge-secondary float-right">0</span></div>
                                                <div class="accordion-body js-accordion-body">
                                                    <div class="accordion-body__contents">
                                                    </div>
                    ...
                    <div class="modal-body project-pipeline">
                        ...
                        <div class="row">
                            <div class="pipeline-small flat pipeline-project p-2 w-100">
                                <a class="won noselect tipped-top text-white w-25" data-toggle="tooltip"
                                    data-placement="top" title="" data-original-title="Plan">&nbsp;<i
                                        class="fa fa-check" aria-hidden="true"></i><br><span>Plan</span>
                                    <span class="stretched-link" data-toggle="modal" data-target="#pipeline-stage"
                                        data-dismiss="modal"></span>
                                </a>
                                <a class="won noselect tipped-top bg-gray text-white w-12" data-toggle="tooltip"
                                    data-placement="top" title="" data-original-title="Design">&nbsp;<i
                                        class="fa fa-check" aria-hidden="true"></i><br><span>Design</span>
                                    <span class="stretched-link" data-toggle="modal" data-target="#pipeline-stage"
                                        data-dismiss="modal"></span>
                                </a>
                                <a class="won noselect tipped-top text-white w-25" data-toggle="tooltip"
                                    data-placement="top" title="" data-original-title="Develop">&nbsp;<i
                                        class="fa fa-check" aria-hidden="true"></i><br><span>Develop</span>
                                    <span class="stretched-link" data-toggle="modal" data-target="#pipeline-stage"
                                        data-dismiss="modal"></span>
                                </a>

                                <a class="won noselect tipped-top text-white padding w-25" data-toggle="tooltip"
        ...
        <div class="modal right fade settings" id="settings" role="dialog" aria-modal="true">
            <div class="toggle-close">
                <div class="toggle" data-toggle="modal" data-target="#settings"><i
                        ...
                        <div class="scroll">
                                                ...
                                                <div class="themes-body">
                                                    <ul id="theme-change"
                                                        ...
                                                        <li class="list-inline-item"><span
                                                                class="theme-solid-black bg-black"></span></li>
                                                        <li class="list-inline-item"><span
                                                                class="theme-solid-pink bg-primary"></span></li>
                                                        <li class="list-inline-item"><span
                                                                class="theme-solid-orange bg-secondary1"></span></li>
                                                        <li class="list-inline-item"><span
                                                                class="theme-solid-purple bg-success"></span></li>

                                                        <li class="list-inline-item"><span
                                                                class="theme-solid-green bg-warnings"></span></li>
                                                        <li><br /></li>
                                                        <li>
                                                            <hr />
                                                        </li>
                                                        ...
                                                        <li class="list-inline-item"><span
                                                                class="theme-orange bg-sunny-morning"></span></li>
                                                        <li class="list-inline-item"><span
                                                                class="theme-blue bg-tempting-azure"></span></li>
                                                        <li class="list-inline-item"><span
                                                                class="theme-grey bg-amy-crisp"></span></li>
                                                        <li class="list-inline-item"><span
                                                                class="theme-lgrey bg-mean-fruit"></span></li>
                                                        <li class="list-inline-item"><span
                                                                class="theme-dblue bg-malibu-beach"></span></li>
                                                        <li class="list-inline-item"><span
                                                                class="theme-pink bg-ripe-malin"></span></li>
                                                        <li class="list-inline-item"><span
                                                                class="theme-purple bg-plum-plate"></span></li>
                                            ...
                                            <div class="themes">
                                                <div class="themes-body">
                                                    <ul id="theme-change1"
                                                        ...
                                                        <li class="list-inline-item"><span
                                                                class="header-gradient-color1 bg-sunny-morning"></span>
                                                        </li>
                                                        <li class="list-inline-item"><span
                                                        ...
                                                        <li class="list-inline-item"><span
                                                                class="header-gradient-color4 bg-mean-fruit"></span>
                                                        </li>
                                                        <li class="list-inline-item"><span
                                                                class="header-gradient-color5 bg-malibu-beach"></span>
                                                        </li>
                                                        <li class="list-inline-item"><span
                                                                class="header-gradient-color6 bg-ripe-malin"></span>
                                                        </li>
                                                        <li class="list-inline-item"><span
                                                                class="header-gradient-color7 bg-plum-plate"></span>
                                                        </li>
                            ...
                            <div>
                                            ...
                                            <div class="themes">
                                                <div class="themes-body">
                                                    <ul id="theme-change2"
                                                        ...
                                                        <li class="list-inline-item"><span
                                                                class="sidebar-gradient-color3 bg-amy-crisp"></span>
                                                        </li>
                                                        <li class="list-inline-item"><span
                                                                class="sidebar-gradient-color4 bg-mean-fruit"></span>
                                                        </li>
                                                        <li class="list-inline-item"><span
                                                                class="sidebar-gradient-color5 bg-malibu-beach"></span>
                                                        </li>
                                                        <li class="list-inline-item"><span
                                                                class="sidebar-gradient-color6 bg-ripe-malin"></span>
                                                        </li>
                                                        <li class="list-inline-item"><span
                                                                class="sidebar-gradient-color7 bg-plum-plate"></span>
                                                        </li>
                                ...
                                <div class="row Default-font">
                                    ...
                                    <div class="col text-right">
                                        <a class="reset text-white bg-dark font-Default"
                                            onclick="ChangeFontDefault()">Reset Default</a>
                                    </div>
                                </div>
                                <ul class="list-inline-item list-unstyled font-family border-0 p-0">
                                    ...
                                    <li class="list-inline-item montserrat-font" onclick="changeFonts3();">Montserrat
                                    </li>
...
<script>
    import list from '../../json/activities/list'
    export default {
        data() {
            return {
                list: list,
