<template>
    <div>
        <div class="main-wrapper">
            ...
            <layout-navbaremail></layout-navbaremail>
           <!-- Page Wrapper -->
										...
										<div class="row web-view">
											<div class="col top-action-left">
												<div class="float-left">
													...
													<div class="btn-group dropdown-action ml-1">
														<button type="button" class="btn btn-white dropdown-toggle" data-toggle="dropdown">Actions <i class="fa fa-angle-down "></i></button>
														<div class="dropdown-menu">
															<a class="dropdown-item" href="#">Reply</a>
															<a class="dropdown-item" href="#">Forward</a>
											...
											<div class="col-auto top-action-right">
												<div class="text-right">
													<button type="button" title="Refresh" data-toggle="tooltip" class="btn btn-white d-none d-md-inline-block mr-1"><i class="fa fa-refresh"></i></button>
													<div class="btn-group">
														<a class="btn btn-white"><i class="fa fa-angle-left"></i></a>
														<a class="btn btn-white"><i class="fa fa-angle-right"></i></a>
													</div>
