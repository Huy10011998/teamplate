          ...
          <div class="modal-body">
            <form class="forms-sample">
              ...
              <div class="text-center">
                <button type="submit" class="btn btn-gradient-primary ms-2 btn-rounded">Submit</button>
              ...
              <div class="modal-body project-pipeline">
                  ...
                  <div class="row m-0">
                      <div class="pipeline-small flat pipeline-project w-100 Prjt-pipilines">
                        <a class="won noselect tipped-top text-white w-25" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Plan">&nbsp;<span>Plan</span>
                            <span class="stretched-link" data-bs-toggle="modal" data-bs-target="#pipeline-stage" data-bs-dismiss="modal"></span>
                        </a>
                        <a class="won noselect tipped-top bg-gray text-white w-12" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Design">&nbsp;<span>Design</span>
                            <span class="stretched-link" data-bs-toggle="modal" data-bs-target="#pipeline-stage" data-bs-dismiss="modal"></span>
                        </a>
                        <a class="won noselect tipped-top text-white w-25" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Develop">&nbsp;<span>Develop</span>
                            <span class="stretched-link" data-bs-toggle="modal" data-bs-target="#pipeline-stage" data-bs-dismiss="modal"></span>
                        </a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer text-center">
                <button type="button" class="border-0 btn btn-primary btn-gradient-primary btn-rounded" data-bs-dismiss="modal">Save</button>&nbsp;&nbsp;
                <button type="button" class="btn btn-secondary btn-rounded cancel-button" data-bs-dismiss="modal">Cancel</button>
              </div>
