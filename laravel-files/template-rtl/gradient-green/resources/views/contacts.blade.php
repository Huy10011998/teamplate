                                    ...
                                    <table class="table table-striped table-nowrap custom-table mb-0 datatable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="avatar flex-shrink-0"><img alt="" src="assets/img/profiles/avatar-11.jpg"></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="avatar flex-shrink-0"><img alt="" src="assets/img/profiles/avatar-10.jpg"></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="avatar flex-shrink-0"><img alt="" src="assets/img/profiles/avatar-25.jpg"></a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="avatar flex-shrink-0"><img alt="" src="assets/img/profiles/avatar-26.jpg"></a>
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#system-user">Wilmer Deluna</a>
                                                </td>
      ...
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="task-infos">
                <ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded nav-justified">
                    <li class="nav-item"><a class="nav-link active" href="#company-task-details" data-bs-toggle="tab">Details</a></li>
                    <li class="nav-item"><a class="nav-link" href="#company-task-related" data-bs-toggle="tab">Related</a></li>
                    <li class="nav-item"><a class="nav-link" href="#company-task-activity" data-bs-toggle="tab">Activity</a></li>
                    
                    <li class="nav-item"><a class="nav-link" href="#company-task-news" data-bs-toggle="tab">News</a></li>
                </ul>
                <div class="tab-content">
