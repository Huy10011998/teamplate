		...
		<!-- Modal -->
			<div class="modal right fade" id="add_activity" tabindex="-1" role="dialog" aria-modal="true">
				<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                  <button type="button"class="btn-close md-close" data-bs-dismiss="modal" aria-label="Close">
              ...
              <div class="modal-dialog" role="document">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <div class="row w-100">
                      <div class="col-md-7 account d-flex">
					    <div class="company_img"><img src="assets/img/c-logo.png" alt="User" class="user-image" /></div>
					    <div>
							<p class="mb-0">Deal</p>
                  ...
                  <div class="modal-body">
                  	...
                  	<div class="row">
                  		<div class="pipeline-small flat pl-3 pr-3 w-100">
		                    <a class="won noselect tipped-top text-white" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i class="fa fa-check" aria-hidden="true"></i><br><span>Prospecting</span></a>
		                    <a class="won noselect tipped-top bg-gray text-white" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i class="fa fa-check" aria-hidden="true"></i><br><span>Qualification</span></a>
		                    <a class="won noselect tipped-top text-white" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i class="fa fa-check" aria-hidden="true"></i><br><span>Needs Analysis</span></a>
		                    <a class="won noselect tipped-top text-white" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i class="fa fa-check" aria-hidden="true"></i><br><span>Proposals</span></a>
		                    <a class="won noselect tipped-top text-white" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline">&nbsp;<i class="fa fa-check" aria-hidden="true"></i><br><span>Nogatiation</span></a>
		                    <a class="won noselect tipped-top text-white padding" data-bs-toggle="tooltip" data-placement="top" title="" data-original-title="Pipeline: Deal Pipeline">&nbsp;closed win</a>
	                    </div>
                  	</div>
